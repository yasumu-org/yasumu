// https://github.com/boa-dev/boa/blob/99642be976c39c7f77966b8f96ea5ce95ecb39fa/core/runtime/src/console/mod.rs
...
fn logger(msg: LogMessage, console_state: &Console) {
    ...
    let output = match msg {
        LogMessage::Error(msg) => {
            ...
            console_state.output.logs.push(log);
            log
        }
        LogMessage::Log(msg) => {
            let log = LogResult {
...
impl Console {
    ...
    pub fn init(context: &mut Context, on_log: fn(LogResult)) -> JsObject {
        Console::on_log = on_log;
        fn console_method(
